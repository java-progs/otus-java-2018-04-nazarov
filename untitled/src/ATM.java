...
public class ATM {
    ...
    public void balancingAtm() {
        cassetes[0].addNotes(1);
        //cassetes[1].addNotes(1);
        cassetes[1].addNotes(2);
    ...
    public void printState() {
        ...
        for (Cassete c : cassetes) {
            System.out.println(String.format("Cassete %s : state %s, nominal %s, capacity %s, count banknotes %s, balance %s",
    ...
    private class CasseteManager {
        ...
        Cassete[] initCassetes = new Cassete[MAX_CASSETES_COUNT];
        ...
        public void printCassetesList() {
            for (Map.Entry<Integer, ArrayList<Cassete>> pair : cassetes.entrySet()) {
                ...
                for (Cassete c : pair.getValue()) {
                    System.out.print(". Cassete : " + c.getName() + ", state : " + c.getState() + ", count : " + c.getCount());
                }
                System.out.println();
            }
        }
            ...
            for (Map.Entry<Integer, ArrayList<Cassete>> pair : cassetes.entrySet()) {
                ...
                if (countNotes > 0)
                    for (Cassete c : pair.getValue()) {
                        ...
                        countNotesFromCassete.put(c, countFromCassete);
